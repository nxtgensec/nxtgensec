...
import { Target, Eye, Heart, History, Lightbulb, Shield, Rocket, Globe } from "lucide-react"
  ...
  const timeline = [
    {
      ...
      title: "Foundation",
      description:
        "NxtGenSec launched on September 8th as a next-generation technology hub, with cybersecurity as our initial focus area while planning broader tech innovations",
    },
    {
      year: "Oct 2024",
      title: "Expansion",
      description:
        "Rapidly expanded into AI development, blockchain solutions, and quantum computing research while building our core team and infrastructure",
    },
    {
      year: "Nov 2024",
      title: "Innovation Surge",
      description:
        "Launched multiple breakthrough projects in AI automation, smart contracts, and advanced analytics - establishing our reputation as tech pioneers",
    },
    {
      year: "Aug 2025",
      title: "Social Media Launch",
      description:
        "Became active across all major social platforms just one week ago, sharing our innovations and connecting with the global tech community",
    },
  ]
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-gray-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-0 right-1/3 w-96 h-96 bg-green-500/3 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative">
            {/* Timeline Line */}
            <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-blue-400 via-green-400 to-orange-400 rounded-full"></div>
              ...
              {timeline.map((item, index) => (
                ...
                >
                  <div className={`w-1/2 ${index % 2 === 0 ? "pr-8 text-right" : "pl-8 text-left"}`}>
                    <div className="nxtgen-card p-6 rounded-xl bg-gray-800/50 border border-gray-700 backdrop-blur-sm">
                      ...
                      <div className="mt-4 flex justify-center">
                        <div className="w-6 h-6 rounded-full bg-blue-400/10 border-2 border-blue-400/20 rotate-slow flex items-center justify-center">
